...
const Checkbox: FC<CheckboxProps> & CheckboxStatic = ({
  ...
  const _renderCheckboxNative = () => {
    return <input value={value} disabled={disabled} className={styles(css.input)} checked={checkedState} type="checkbox" onChange={_handleChange} />;
  };
