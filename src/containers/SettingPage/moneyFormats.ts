const moneyFormats = {
  ...
  KWD: {
    ...
    money_with_currency_format: 'د.ك{{amount}} KWD',
    money_name: 'Kuwaiti Dinar',
  },
  KGS: {
    money_format: 'сом{{amount}}',
    money_with_currency_format: 'сом{{amount}} KGS',
  ...
  OMR: {
    money_format: 'ر.ع.{{amount}}',
    money_with_currency_format: 'ر.ع.{{amount}} OMR',
  ...
  SEK: {
    ...
    money_with_currency_format: '{{amount_with_comma_separator}}kr SEK',
  ...
  ERN: {
    money_format: '{{amount}} ERN',
    money_with_currency_format: '{{amount}} ERN',
    money_name: 'Eritrean Nakfa',
  },
  EEK: {
    money_format: '{{amount}} EEK',
